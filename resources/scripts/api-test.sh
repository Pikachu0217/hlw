...
run_all_cases() {
  ...
  run_case "创建后台用户" "POST" "/system/users" "{\"username\":\"api_user\",\"phone\":\"13800006666\",\"deptName\":\"接口测试部\",\"roleName\":\"接口测试角色\",\"userType\":\"ADMIN\",\"status\":\"启用\"}"
  run_case "查询角色列表" "GET" "/system/roles"
  run_case "创建角色" "POST" "/system/roles" "{\"roleName\":\"接口测试角色\",\"roleCode\":\"API_TEST_ROLE\",\"dataScope\":\"本租户数据\",\"status\":\"启用\"}"
  run_case "查询菜单列表" "GET" "/system/menus"
  run_case "创建菜单" "POST" "/system/menus" "{\"menuName\":\"接口测试菜单\",\"permission\":\"api:test:menu\",\"routePath\":\"/api-test/menu\",\"menuType\":\"菜单\",\"parentId\":0,\"sort\":99,\"status\":\"启用\"}"
  ...
  run_case "创建权限码" "POST" "/system/permissions" "{\"permissionName\":\"接口测试权限\",\"permissionCode\":\"api:test:create\",\"resourceType\":\"按钮\",\"menuId\":1,\"status\":\"启用\"}"
