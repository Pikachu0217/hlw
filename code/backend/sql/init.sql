...
ALTER TABLE con_consult ADD COLUMN IF NOT EXISTS duration_limit INT NOT NULL DEFAULT 0;
ALTER TABLE con_consult ADD COLUMN IF NOT EXISTS remaining_seconds INT NOT NULL DEFAULT 0;
ALTER TABLE con_consult ADD COLUMN IF NOT EXISTS start_time TIMESTAMP;
ALTER TABLE con_consult ADD COLUMN IF NOT EXISTS end_time TIMESTAMP;
...
ALTER TABLE pre_prescription ADD COLUMN IF NOT EXISTS pharmacist_id BIGINT;
ALTER TABLE pre_prescription ADD COLUMN IF NOT EXISTS audit_remark VARCHAR(512);
ALTER TABLE pre_prescription ADD COLUMN IF NOT EXISTS submit_time TIMESTAMP;
ALTER TABLE pre_prescription ADD COLUMN IF NOT EXISTS audit_time TIMESTAMP;
...
ALTER TABLE ord_order ADD COLUMN IF NOT EXISTS pay_method VARCHAR(32);
ALTER TABLE ord_order ADD COLUMN IF NOT EXISTS pay_time TIMESTAMP;
