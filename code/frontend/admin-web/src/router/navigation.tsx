...
export const navigationTree: NavigationItem[] = [
  ...
  { key: 'tenant', label: '租户管理', path: '/tenant', icon: <ShopOutlined /> },
  {
    ...
    children: [
      ...
      { key: 'system-dicts', label: '字典管理', path: '/system/dicts' },
      { key: 'system-configs', label: '参数配置', path: '/system/configs' },
      { key: 'system-posts', label: '岗位管理', path: '/system/posts' },
      { key: 'system-permissions', label: '权限管理', path: '/system/permissions' },
    ],
  },
  {
    key: 'doctor',
